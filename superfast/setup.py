...
This file basically just uses CMake to compile a python extension project and
then puts the outputs into standard python packages.
...
class PyTest(TestCommand):
    ...
    def initialize_options(self):
        ...
        # ignore some folders from the scan for python tests.  List whatever you want here
...
setup(
    name='superfast',
    version='1.2.3',
    description='This code is super fast!',
    long_description='Some useful long description of your project',
    author='Davis King',
    author_email='davis@dlib.net',
    license='Public Domain',
    ext_modules=[CMakeExtension('superfast','.')],
